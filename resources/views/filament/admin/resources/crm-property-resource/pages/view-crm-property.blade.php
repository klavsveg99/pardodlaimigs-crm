<x-filament-panels::page>
    ...
    <x-filament::section heading="Pamatdati">
        ...
        @if($record->status === 'sold')
            <div class="mt-6 grid gap-3 grid-cols-1 md:grid-cols-3">
                ...
                <div class="rounded-xl border border-[var(--pdc-primary)] bg-[var(--pdc-primary)]/10 p-4 dark:border-[var(--pdc-primary)]/30 dark:bg-[var(--pdc-primary)]/20">
    ...
    <x-filament::section heading="Atrašanās vieta">
        ...
        @if($record->lat && $record->lng)
            <div class="mt-6 rounded-xl overflow-hidden border border-gray-200 dark:border-[#27303a] shadow-sm" style="height: 220px;">
        ...
        @else
            <div class="text-center rounded-xl border-2 border-dashed border-gray-200 p-8 dark:border-[#27303a]">
                <div class="flex items-center justify-center gap-3">
                    <svg class="h-10 w-10 max-w-[60px] shrink-0 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
